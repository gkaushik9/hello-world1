...
/**
 * Precompiled com.example.maven-project.java-conventions script plugin.
 **/
public class ComExampleMavenProjectJavaConventionsPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> pluginsBlockClass = Class.forName("cp_precompiled_ComExampleMavenProjectJavaConventions").asSubclass(BasicScript.class);
            ...
            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_ComExampleMavenProjectJavaConventions").asSubclass(BasicScript.class);
